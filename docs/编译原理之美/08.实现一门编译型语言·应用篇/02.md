...
![](/images/编译原理之美/08.实现一门编译型语言·应用篇/resourceimage386b38974ba1d07fc5dfe4e72ebfa2cedf6b.jpg)

**栈机是基于操作数栈做计算的。**以“2+3”的计算为例，只要把它转化成逆波兰表达式，“2 3 +”，然后按照顺序执行就可以了。**也就是：**先把2入栈，再把3入栈，再执行加法指令，这时，要从栈里弹出2个操作数做加法计算，再把结果压入栈。

![](/images/编译原理之美/08.实现一门编译型语言·应用篇/resourceimage2b4d2b58a2c9a363e7060f142ddfd7ce514d.jpg)
...
![](/images/编译原理之美/08.实现一门编译型语言·应用篇/resourceimagec6afc6d81160a05835619ae5d9feef1453af.jpg)
...
![](/images/编译原理之美/08.实现一门编译型语言·应用篇/resourceimage0ce20cbaed1b5f15b78ea9634a17e75eece2.jpg)

你可以用“hexdump MyClass.class”显示字节码文件的内容，从中可以发现这个片段（就是橙色框里的内容）：

![](/images/编译原理之美/08.实现一门编译型语言·应用篇/resourceimage206f20b0e2798c15eccc3d440e084af3a76f.png)
...
![](/images/编译原理之美/08.实现一门编译型语言·应用篇/resourceimageef25efaca94bf71023d66352f17b3f8d9025.jpg)

**Spring采用的代理技术有两个：**一个是Java的动态代理（dynamic proxy）技术；一个是采用cglib自动生成代理，cglib采用了asm来生成字节码。

![](/images/编译原理之美/08.实现一门编译型语言·应用篇/resourceimage006900d79a0d34441fe5962aa50682be4869.jpg)
