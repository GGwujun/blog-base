...
![](/images/操作系统实战/02.尝尝鲜从一个Hello到另一个Hello/resourceimage1ddc1db2342da1abdc9f1f77e4c69a94d0dc.png)

那在写Hello OS之前，我们先要搞清楚Hello OS的引导流程，如下图所示：

![](/images/操作系统实战/02.尝尝鲜从一个Hello到另一个Hello/resourceimagef2bdf2d31ab7144bf309761711efa9d6d4bd.jpg "Hello OS引导流程图")
...
![](/images/操作系统实战/02.尝尝鲜从一个Hello到另一个Hello/resourceimage78f5782ef574b96084fa44a33ea1f83146f5.jpg "计算机显卡文本模式")
...
![](/images/操作系统实战/02.尝尝鲜从一个Hello到另一个Hello/resourceimagecb34cbd634cd5256e372bcbebd4b95f21b34.jpg "Hello OS编译过程")
